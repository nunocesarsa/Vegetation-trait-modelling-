...
write.csv(out.df.3,paste(dump.fld,"Optim_3Param_outdata_BroadL.csv",sep="/"))
write.csv(out.df.4,paste(dump.fld,"Optim_4Param_outdata_BroadL.csv",sep="/"))
write.csv(out.df.5,paste(dump.fld,"Optim_5Param_outdata_BroadL.csv",sep="/"))
...
write.csv(sum.out.df,paste(dump.fld,"Optim_3Param_MAPE_Summary_BroadL.csv",sep="/"))
...
#saving the plots
tiff(paste(dump.fld,"Optim5Params_BroadL.tiff",sep="/"),
...
tiff(paste(dump.fld,"Optim4Params_BroadL.tiff",sep="/"),
     units="px", width = 1024, height = 1024, res=124,
     compression = c("lzw"))
grid.arrange(cab.4.SCE, cab.4.LBF,
             Cw.4.SCE,  Cw.4.LBF,
...
tiff(paste(dump.fld,"Optim3Params_BroadL.tiff",sep="/"),
     units="px", width = 1024, height = 1024, res=124,
     compression = c("lzw"))
